...
1. 模版中获取调用
    ...
    拆分模块并开启命名空间后调用mutations：`$store.commit('模块名/方法名', 传递参数)`
...
3. 通过辅助函数获取
    ...
    拆分模块并开启命名空间后通过辅助函数获取getters：`...mapGetters('模块名', ['属性名'])`
...
解决方案参考csdnhttps://blog.csdn.net/qq_40462931/article/details/141704741
