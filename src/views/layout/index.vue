...
<!--    </keep-alive>-->
    ...
    <van-tabbar v-model="active" route>
      <van-tabbar-item icon="wap-home" to="/home" replace>首页</van-tabbar-item>
      <van-tabbar-item icon="list-switching" to="/sort" replace>分类</van-tabbar-item>
      <van-tabbar-item icon="shopping-cart" to="/cart" replace>购物车</van-tabbar-item>
      <van-tabbar-item icon="contact" to="/my" replace>我的</van-tabbar-item>
    </van-tabbar>
  </div>
