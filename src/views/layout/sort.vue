<template>
  <div class="category">
    ...
    <div class="list-box">
      ...
      <div class="right">
        <div @click="$router.push(`/searchList?sortId=${item.category_id}`)" v-for="item in list[activeIndex]?.children" :key="item.category_id" class="cate-goods">
...
export default {
  ...
  methods: {
    async getSortList () {
      const { data: { list } } = await fetchSortList()
      this.list = list
    }
  }
}
